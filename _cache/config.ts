...
export default {
  global: {
     ...
     */
    opg: {
      'profile:first_name': 'Anatoly',
      'profile:gender': 'male', // male, female
      'profile:last_name': 'Khalizev',
    },
  ...
  data: {
     ...
     */
    socialMedia: [
      { name: 'Github', icon: 'github', link: 'https://github.com/akhalizev' },
      { name: 'LinkedIn', icon: 'linkedin', link: 'https://www.linkedin.com/in/akhalizev/' },
    ],
  },
  ...
  modules: {
    github: {
       ...
       */
      token: process.env.GITHUB_TOKEN || '4a72660c53b830d0e0eed11ea39465a00ff6d972',
